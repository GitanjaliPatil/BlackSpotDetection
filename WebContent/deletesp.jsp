        ...
        <div class="header-top-w3layouts">
            <div class="container">
                ...
                <h2 class="text-center mb-4"> 
							...
							try
							{
								String splc=request.getParameter("splocat");
								
								Connection con=Connect.getConnect();
								PreparedStatement ps3=con.prepareStatement("select * from pstbl where spotloc=?");
								ps3.setString(1, splc);
								...
								PreparedStatement ps4=con.prepareStatement("delete from pstbl where spotloc=?");
								ps4.setString(1, splc);
								...
								{
									response.sendRedirect("deletesp.jsp");
								}
							}
							catch(Exception e)
							{
