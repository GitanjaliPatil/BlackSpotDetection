        ...
        <div class="header-top-w3layouts">
            <div class="container">
                ...
                <h2 class="text-center mb-4"> 
                               <p style="color:white;">All Black Spot</p>
                            
                            </h2>
                        <form action="adminviewspot.jsp">
                           ...
                           <table class="table">
							...
							try
							{
								...
								PreparedStatement ps2=con.prepareStatement("select * from pstbl");
								...
								while(rs1.next())
								{
							 	%>
										    ...
										    <tr>
										      <th scope="row"><p style="color:white;"><%=rs1.getString(1) %></p>  </th>
										      <td><p style="color:white;"><%=rs1.getString(2) %></p> </td>
										      <td><p style="color:white;"><%=rs1.getString(3) %></p> </td>
										      <td><p style="color:white;"><%=rs1.getString(4) %></p> </td>
										      <td><p style="color:white;"><%=rs1.getString(5) %></p> </td>
										      <td><p style="color:white;"><%=rs1.getString(6) %></p> </td>
										      <td><p style="color:white;"><%=rs1.getString(7) %></p> </td>
						...
						<div class="text-center">
 									<a href="login1.html"><button type="button">Back</button></a>
								</div>
