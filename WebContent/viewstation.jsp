        ...
        <div class="header-top-w3layouts">
            <div class="container">
                ...
                <h2 class="text-center mb-4"> 
                              <p style="color:white;">Police Stations</p>  
                            
                            </h2>
                        <form action="viewstation.jsp">
                           ...
                           <table class="table">
							...
							try
							{
								...
								PreparedStatement ps2=con.prepareStatement("select * from admintbl1");
								...
								while(rs1.next())
								{
							 	%>
										    ...
										    <tr>
										      <th scope="row"><p style="color:white;"><%=rs1.getInt(1) %></p>  </th>
