        ...
        <div class="header-top-w3layouts">
            <div class="container">
                ...
                <h2 class="text-center mb-4"> 
                              <p style="color:white;">Spot Report Accordingly Zone</p>  
                        ...
                        <form >
                           ...
                           <table class="table">
							...
							try
							{
								String znm =request.getParameter("zname");
								
								Connection con=Connect.getConnect();
								PreparedStatement ps7=con.prepareStatement("select * from pstbl where spotlevel=?");
								ps7.setString(1, znm);
