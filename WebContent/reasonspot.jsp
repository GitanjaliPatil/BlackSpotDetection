        ...
        <div class="header-top-w3layouts">
            <div class="container">
                ...
                <h2 class="text-center mb-4"> 
                              <p style="color:white;">Black Spot Report Accordingly Reason</p>  
                        ...
                        <form >
                           ...
                           <table class="table">
							...
							try
							{
								String reasonnm =request.getParameter("rname");
								
								Connection con=Connect.getConnect();
								PreparedStatement ps7=con.prepareStatement("select * from pstbl where spotreason=?");
								ps7.setString(1, reasonnm);
						...
						<div class="text-center">
 									<a href="login2.html"><button type="button">Back</button></a>
								</div>
